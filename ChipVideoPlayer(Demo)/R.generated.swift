...
struct R: Rswift.Validatable {
  ...
  struct image {
    /// Image `account28`.
    static let account28 = Rswift.ImageResource(bundle: R.hostingBundle, name: "account28")
    /// Image `arrow-left`.
    ...
    /// Image `search24`.
    static let search24 = Rswift.ImageResource(bundle: R.hostingBundle, name: "search24")
    /// Image `search28`.
    static let search28 = Rswift.ImageResource(bundle: R.hostingBundle, name: "search28")
    /// Image `trash`.
    static let trash = Rswift.ImageResource(bundle: R.hostingBundle, name: "trash")
    /// Image `user`.
    static let user = Rswift.ImageResource(bundle: R.hostingBundle, name: "user")
    /// Image `videos28`.
    static let videos28 = Rswift.ImageResource(bundle: R.hostingBundle, name: "videos28")
    /// Image `x`.
    static let x = Rswift.ImageResource(bundle: R.hostingBundle, name: "x")

    #if os(iOS) || os(tvOS)
    /// `UIImage(named: "account28", bundle: ..., traitCollection: ...)`
    static func account28(compatibleWith traitCollection: UIKit.UITraitCollection? = nil) -> UIKit.UIImage? {
      return UIKit.UIImage(resource: R.image.account28, compatibleWith: traitCollection)
    }
    #endif
    ...
    #if os(iOS) || os(tvOS)
    /// `UIImage(named: "search24", bundle: ..., traitCollection: ...)`
    static func search24(compatibleWith traitCollection: UIKit.UITraitCollection? = nil) -> UIKit.UIImage? {
      return UIKit.UIImage(resource: R.image.search24, compatibleWith: traitCollection)
    }
    #endif

    #if os(iOS) || os(tvOS)
    /// `UIImage(named: "search28", bundle: ..., traitCollection: ...)`
    static func search28(compatibleWith traitCollection: UIKit.UITraitCollection? = nil) -> UIKit.UIImage? {
      return UIKit.UIImage(resource: R.image.search28, compatibleWith: traitCollection)
    }
    #endif
    ...
    #if os(iOS) || os(tvOS)
    /// `UIImage(named: "videos28", bundle: ..., traitCollection: ...)`
    static func videos28(compatibleWith traitCollection: UIKit.UITraitCollection? = nil) -> UIKit.UIImage? {
      return UIKit.UIImage(resource: R.image.videos28, compatibleWith: traitCollection)
    }
    #endif
